      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center">
            <span>
              © {year} | Made with <Heart className="inline h-4 w-4 text-red-500" /> by S Saikrishna
            </span>
          </div>
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <a href="mailto:sunkarisaikrishna22cm@student.vardhaman.org" className="hover:text-primary transition-colors">
